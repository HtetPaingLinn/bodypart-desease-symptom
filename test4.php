...
<head>
    ...
    <style>
        *{
        ...
        body {
            transform: scale(0.85); /* 80% of the original size */
            transform-origin: top left; /* Adjust the origin point if needed */
        }
...
<body class="bg-white flex">
    <div id="frontView" class="block wrap_img w-1/2 p-4">
        <img class="frontBodyImage" id="frontBodyImage" src="../img/human-body-front.png" usemap="#front-image-map" alt="Human Body">
        ...
        <img id="toggleViewButton" class="bottom-2 right-2 w-32 cursor-pointer border-2 border-green-400 rounded hover:bg-green-200" src="../img/human-body-back.png" alt="Switch to Back View">
    </div>
    
    <div id="backView" class="hidden w-1/2 p-4">
        <img id="backBodyImage" src="../img/human-body-back.png" usemap="#back-image-map" alt="Human Body">
        ...
        <img id="toggleViewButton" class="bottom-2 right-2 w-32 cursor-pointer border-2 border-green-400 rounded hover:bg-green-200" src="../img/human-body-front.png" alt="Switch to Front View">
    </div>
...
<script>
<?php
// Define the path to the Prolog file
$filename = 'diseases.pl';

// Read the contents of the Prolog file
$fileContents = file_get_contents($filename);

// Split the contents into lines
$lines = explode("\n", $fileContents);

// Initialize an array to hold the diseases categorized by body part
$diseases = [];
...
foreach ($lines as $line) {
    ...
    // Add the disease to the appropriate body part category
...
function predictDisease() {
    ...
    const highlightedImages = {
        head: "../img/front-head-selected.png",
        neck: "../img/front-neck-selected.png",
        chest: "../img/front-chest-selected.png",
        abdomen: "../img/front-abdomen-selected.png",
        pelvis: "../img/front-pelvis-selected.png",
        thighs: "../img/front-thighs-selected.png",
        knees: "../img/front-knees-selected.png",
        legs: "../img/front-legs-selected.png",
        ankles: "../img/front-ankles-selected.png",
        feet: "../img/front-feet-selected.png",
        shoulders: "../img/front-shoulders-selected.png",
        arms: "../img/front-arms-selected.png",
        foreArms: "../img/front-fore-arms-selected.png",
        wrists: "../img/front-wrists-selected.png",
        hands: "../img/front-hands-selected.png",
    };

    const defaultImage = "../img/human-body-front.png";
    ...
    <script>
        ...
        const highlightedBackHeadImage = "../img/back-head-selected.png";
        const highlightedBackNeckImage = "../img/back-neck-selected.png";
        const highlightedBackBackImage = "../img/back-back-selected.png";
        const highlightedBackLoinImage = "../img/back-loin-selected.png";
        const highlightedBackButtocksImage = "../img/back-buttocks-selected.png";
        const highlightedBackHamstringImage = "../img/back-hamstrings-selected.png";
        const highlightedBackKneesImage = "../img/back-knees-selected.png";
        const highlightedBackCalvesImage = "../img/back-calves-selected.png";
        const highlightedBackAnklesImage = "../img/back-ankles-selected.png";
        const highlightedBackSolesImage = "../img/back-soles-selected.png";
        const highlightedBackFeetImage = "../img/back-feet-selected.png";
        const highlightedBackShouldersImage = "../img/back-shoulders-selected.png";
        const highlightedBackArmsImage = "../img/back-arms-selected.png";
        const highlightedBackElbowsImage = "../img/back-elbows-selected.png";
        const highlightedBackForeArmsImage = "../img/back-fore-arms-selected.png";
        const highlightedBackWristsImage = "../img/back-wrists-selected.png";
        const highlightedBackHandsImage = "../img/back-hands-selected.png";

        // Path to the default image
        const defaultBackImage = "../img/human-body-back.png";
        ...
        toggleButton.forEach(button => {
            button.addEventListener('click', function() {
                if (frontView.style.display === 'none' || frontView.style.display === '') {
                    ...
                    toggleButton[0].src = '../img/human-body-back.png'; // Set image to back view on switch
                    toggleButton[1].src = '../img/human-body-back.png';
                } else {
                    frontView.style.display = 'none';
                    backView.style.display = 'block';
                    toggleButton[0].src = '../img/human-body-front.png'; // Set image to front view on switch
                    toggleButton[1].src = '../img/human-body-front.png';
                }
            });
        });
